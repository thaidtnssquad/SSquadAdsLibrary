...
object AdsConstants {
    ...
    val admobInterModelTest =
        AdmobInterModel("ca-app-pub-3940256099942544/1033173712")
    val admobNativeModelTest =
        AdmobNativeModel("ca-app-pub-3940256099942544/2247696110")
    val admobRewardedModelTest =
    ...
    val maxNativeModelTest = MaxNativeModel("0f688c4e22b9688b")
    val maxRewardedModelTest = MaxRewardedModel("c10d259dcb47378d")
    const val MAX_BANNER_TEST = "f443c90308f39f17"
